...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <p class="card-text">Pour <a href="" class="btn btn-primary"
                                            data-bs-toggle="modal" data-bs-target="#operationAdd">insérer un nouvelle
                                            ligne</a></p>
                                        ...
                                        <table class="table table-lg">
                                            ...
                                            <tbody>
                                                @forelse ($operation as $operations)
                                                    <tr>
                                                        <td class="text-bold-500">{{ $operations->user->nom}}</td>
                                                        <td class="text-bold-500">{{ $operations->patient->nom }}</td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary" data-bs-toggle="modal"
                                                                data-bs-target="#operationUpdate{{ $operations->id }}"
                                                                href="#">
                                                                Modifier
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-danger" data-bs-toggle="modal"
                                                                data-bs-target="#operationDestroy{{ $operations->id }}"
                                                                href="#">
                                                                Supprimer
                                                            </a>
                                                        </td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                                                    Non </button>
                                                <button type="submit" name="okmodalvote" class="btn btn-primary"> Oui
                                                </button>
                                            </div>
                                            </form>
                                        </div>
    ...
    <div class="modal fade admin-query" id="operationAdd" data-bs-backdrop="static" data-bs-keyboard="false"
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                ...
                                                <datalist id="patient_id">
                                                    @foreach ($patients as $patient)
                                                        <option value="{{ $patient->matricule }}">
                                                            {{ $patient->nom }}</option>
                                                    @endforeach
                                                </datalist>
                                            </div>
